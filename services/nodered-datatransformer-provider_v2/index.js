...
router.post('/installNode/:datatransformerId', (req, res) => {
    services.installNode(req.body,req.params.datatransformerId).then((apiresponse) => {
        res.status(apiresponse.code).json({ message: apiresponse.message});
    });
});
